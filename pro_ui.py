...
from lite_ui import Mainwindow
...
class MainWindow (CTk):
    def __init__ (self):
        ...
        try:
            ...
            self.addmessage(f"Не вдалося підключитись до сервера:{e}")
    ...
    def adaptive_ui(self):
        ...
        self.open_img_button.place(x=self.winfo_width() - 105,
    ...
    def add_message(self, message, img=None):
        ...
        if not img:
            ...
            CTkLabel(message_frametext=message,wraplength=wrapleng_size,text_color='white',image=img,compound='top',justify='left').pack(padx=10, pady=5)
    ...
    def open_image(self):
        ...
        try:
            ...
            self.add_message(f"Не вдалося надіслати зобраення:{e}")
